...
from Wolf import ASCETIC, LOGGER, MASTER, app, dispatcher, function

USERS_GROUP = 4
CHAT_GROUP = 5
DEV_AND_MORE = ASCETIC.append(int(MASTER))
...
async def broadcast_cmd(client: Client, message: Message):
    ...
    if user_id not in [MASTER] + ASCETIC:
...
async def log_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if msg.forward_origin:
        sql.update_user(msg.forward_origin.USER)
