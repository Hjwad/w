...
import Database.globans_sql as sql
...
from Wolf.utils.admin import (
    admin_only,
    is_user_admin,
    support_plus,
)
from Wolf.utils.extraction import extract_user, extract_user_and_text
from Wolf.utils.misc import send_to_list
...
async def gban(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, ASCETIC, log_message, html=True)
...
async def ungban(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, ASCETIC, "un-gban complete!")
