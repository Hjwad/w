    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 6 : 6 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("Main", callback_data="io_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("Retreat", callback_data="io_back")]]
